...
INSERT INTO user (enabled, first_name, last_name, password, username, email, create_user_username, create_date, assigned_department_id, assigned_team_id) VALUES(TRUE, 'Frank', 'Merkwürdig', '$2a$10$d8cQ7Euz2hM43HOHWolUGeCEZSS/ltJVJYiJAmczl1X5FKzCjg6PC', 'user3', 'jamie.hochrainer@student.uibk.ac.at', 'admin', '2016-01-01 00:00:00',1,1);
