...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (5,DATE(NOW() - INTERVAL 1 WEEK), DATE(NOW() - INTERVAL 3 HOUR), NOW(), 'admin', 3,1,1,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (6,DATE(NOW() - INTERVAL 1 WEEK), DATE(NOW() - INTERVAL 4 HOUR), NOW(), 'admin', 2,1,1,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (7,DATE(NOW() - INTERVAL 1 WEEK), DATE(NOW() - INTERVAL 5 HOUR), NOW(), 'admin', 3,1,1,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (8,DATE(NOW() - INTERVAL 4 WEEK), DATE(NOW() - INTERVAL 1 WEEK), NOW(), 'admin', 9,1,1,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (9,DATE(NOW() - INTERVAL 1 HOUR), DATE(NOW() - INTERVAL 2 HOUR), NOW(), 'admin', 12,1,1,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (10,DATE(NOW() - INTERVAL 1 WEEK), DATE(NOW() - INTERVAL 3 HOUR), NOW(), 'user1', 3,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (11,DATE(NOW() - INTERVAL 1 WEEK), DATE(NOW() - INTERVAL 4 HOUR), NOW(), 'user1', 2,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (12,DATE(NOW() - INTERVAL 1 WEEK), DATE(NOW() - INTERVAL 5 HOUR), NOW(), 'user1', 3,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (13,DATE(NOW() - INTERVAL 4 WEEK), DATE(NOW() - INTERVAL 1 WEEK), NOW(), 'user1', 9,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (14,DATE(NOW() - INTERVAL 1 HOUR), DATE(NOW() - INTERVAL 2 HOUR), NOW(), 'user1', 12,1,3,1);