...
INSERT INTO dice(ID, internal_id, object_created_date_time, object_changed_date_time, object_created_user_username, object_changed_user_username, is_active, user_username, assigned_raspberry_id, last_battery_status) VALUES (1, 'test1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'admin', 'admin', TRUE, 'admin', 1, 50);
...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (1, NOW() - INTERVAL 1 HOUR - INTERVAL 30 MINUTE, NOW() - INTERVAL 2 HOUR, NOW(), 'user2', 9,1,'user2',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (2,NOW() - INTERVAL 2 HOUR, NOW() - INTERVAL 3 HOUR, NOW(), 'user2', 3,1,'user2',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (3, NOW() - INTERVAL 3 HOUR, NOW() - INTERVAL 4 HOUR, NOW(), 'user2', 2,1,'user2',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (4,NOW() - INTERVAL 4 HOUR, NOW() - INTERVAL 5 HOUR, NOW(), 'user2', 3,1,'user2',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (5,NOW() - INTERVAL 13 DAY, NOW() - INTERVAL 13 DAY - INTERVAL 3 HOUR, NOW(), 'user2', 3,1,'user2',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (6,NOW() - INTERVAL 28 HOUR, NOW() - INTERVAL 34 HOUR, NOW(), 'admin', 2,1,'admin',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (7,NOW() - INTERVAL 3 HOUR, NOW() - INTERVAL 8 HOUR , NOW(), 'admin', 3,1,'admin',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (8,NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 6 DAY - INTERVAL 1 HOUR, NOW(), 'admin', 9,1,'admin',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (9,NOW() - INTERVAL 1 HOUR, NOW() - INTERVAL 2 HOUR, NOW(), 'admin', 12,1,'admin',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (10,NOW() - INTERVAL 1 HOUR, NOW() - INTERVAL 3 HOUR, NOW(), 'user1', 3,1,'user1',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (11,NOW() - INTERVAL 1 WEEK + INTERVAL 1 HOUR, NOW() - INTERVAL 1 WEEK, NOW(), 'user1', 2,1,'user1',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (12,NOW() - INTERVAL 7 HOUR, NOW() - INTERVAL 8 HOUR, NOW(), 'user1', 1,1,'user1',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (13,NOW() - INTERVAL 1 WEEK, NOW() - INTERVAL 1 WEEK - INTERVAL 30 MINUTE, NOW(), 'user1', 9,1,'user1',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (14,NOW() - INTERVAL 3 HOUR, NOW() - INTERVAL 8 HOUR, NOW(), 'user1', 2,1,'user1',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (15,NOW() - INTERVAL 2 HOUR, NOW() - INTERVAL 5 HOUR, NOW(), 'user1', 12,1,'user1',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (16,NOW() - INTERVAL 2 DAY + INTERVAL 2 HOUR, NOW() - INTERVAL 2 DAY, NOW(), 'user1', 8,1,'user1',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (17,NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 4 DAY - INTERVAL 1 HOUR, NOW(), 'user3', 5,1,'user3',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (19,NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY - INTERVAL 2 HOUR, NOW(), 'user1', 7,1,'user1',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (20,NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY - INTERVAL 2 HOUR, NOW(), 'admin', 7,1,'admin',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (21,NOW() - INTERVAL 5 HOUR, NOW() - INTERVAL 7 HOUR , NOW(), 'admin', 11,1,'admin',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (22,NOW() - INTERVAL 3 HOUR, NOW() - INTERVAL 10 HOUR , NOW(), 'admin', 3,1,'admin',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (23,NOW() - INTERVAL 3 HOUR, NOW() - INTERVAL 5 HOUR , NOW(), 'admin', 4,1,'admin',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (24,NOW() - INTERVAL 2 HOUR, NOW() - INTERVAL 9 HOUR , NOW(), 'admin', 6,1,'admin',1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, user_username, team_id) VALUES (25,NOW() - INTERVAL 3 HOUR, NOW() - INTERVAL 7 HOUR , NOW(), 'admin', 7,1,'admin',1);

INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(1, 'Bugsimilian', DATE(NOW() - INTERVAL 5 DAY), DATE(NOW()), 'admin', 'Most hours debugging');
INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(2, 'Code Raptor Georg', DATE(NOW() - INTERVAL 5 DAY), DATE(NOW()), 'admin', 'Most hours implementation');
INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(3, 'Bugsimilian', DATE(NOW() - INTERVAL 5 DAY), DATE(NOW()), 'user1', 'Most hours debugging');
INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(4, 'Frontend Laura', DATE(NOW() - INTERVAL 5 DAY), DATE(NOW()), 'user1', 'Most hours frontend');
...
INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(11, 'Bugsimilian', DATE(NOW() - INTERVAL 10 DAY), DATE(NOW() - INTERVAL 5 DAY), 'user1', 'Most hours debugging');
INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(12, 'Code Raptor Georg', DATE(NOW() - INTERVAL 10 DAY), DATE(NOW() - INTERVAL 5 DAY), 'user1', 'Most hours implementation');
INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(13, 'Frontend Laura', DATE(NOW() - INTERVAL 10 DAY), DATE(NOW() - INTERVAL 5 DAY), 'user1', 'Most hours frontend');
INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(14, 'Busy Bee Jamie', DATE(NOW() - INTERVAL 10 DAY), DATE(NOW() - INTERVAL 5 DAY), 'user1', 'Most hours managing');
INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(15, 'Educated Gabbo', DATE(NOW() - INTERVAL 10 DAY), DATE(NOW() - INTERVAL 5 DAY), 'admin', 'Most hours training and testing');
INSERT INTO badgedb (id, badge_name, from_date, to_date, user_username, explanation) values(16, 'The Sloth', DATE(NOW() - INTERVAL 10 DAY), DATE(NOW() - INTERVAL 5 DAY), 'admin', 'Most hours pause/vacation');
