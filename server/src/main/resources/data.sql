...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (1,NOW() - INTERVAL 1 HOUR, NOW() - INTERVAL 2 HOUR, NOW(), 'user2', 9,1,2,1);
...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (21,(NOW() - INTERVAL 5 HOUR), NOW() - INTERVAL 10 HOUR , NOW(), 'admin', 11,1,1,1);
