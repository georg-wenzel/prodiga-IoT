...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (8,NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 6 DAY - INTERVAL 1 HOUR, NOW(), 'admin', 9,1,1,1);
...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (11,NOW() - INTERVAL 1 WEEK + INTERVAL 1 HOUR, NOW() - INTERVAL 1 WEEK, NOW(), 'user1', 2,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (12,NOW() - INTERVAL 7 HOUR, NOW() - INTERVAL 8 HOUR, NOW(), 'user1', 1,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (13,NOW() - INTERVAL 1 WEEK, NOW() - INTERVAL 1 WEEK - INTERVAL 30 MINUTE, NOW(), 'user1', 9,1,3,1);
...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (16,NOW() - INTERVAL 2 DAY + INTERVAL 2 HOUR, NOW() - INTERVAL 2 DAY, NOW(), 'user1', 8,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (17,NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 4 DAY - INTERVAL 1 HOUR, NOW(), 'user3', 5,1,4,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (19,NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY - INTERVAL 2 HOUR, NOW(), 'user1', 7,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (20,NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 1 DAY - INTERVAL 2 HOUR, NOW(), 'admin', 7,1,1,1);
