...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (5,DATE(NOW() - INTERVAL 1 WEEK), DATE(NOW() - INTERVAL 3 WEEK), NOW(), 'admin', 3,1,1,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (6,DATE(NOW() - INTERVAL 1 HOUR), DATE(NOW() - INTERVAL 4 HOUR), NOW(), 'admin', 2,1,1,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (7,DATE(NOW() - INTERVAL 10 HOUR), DATE(NOW() - INTERVAL 1 WEEK), NOW(), 'admin', 3,1,1,1);
...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (10,DATE(NOW() - INTERVAL 1 HOUR), DATE(NOW() - INTERVAL 3 HOUR), NOW(), 'user1', 3,1,3,1);
...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (12,DATE(NOW() - INTERVAL 8 HOUR), DATE(NOW() - INTERVAL 1 WEEK), NOW(), 'user1', 1,1,3,1);
...
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (14,DATE(NOW() - INTERVAL 3 HOUR), DATE(NOW() - INTERVAL 8 HOUR), NOW(), 'user1', 2,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (15,DATE(NOW() - INTERVAL 1 DAY), DATE(NOW() - INTERVAL 3 DAY), NOW(), 'user1', 8,1,3,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (16,DATE(NOW() - INTERVAL 4 DAY), DATE(NOW() - INTERVAL 5 DAY), NOW(), 'user3', 5,1,4,1);
INSERT INTO booking (id, activity_end_date, activity_start_date, object_created_date_time, object_created_user_username, booking_category_id, dept_id, dice_id, team_id) VALUES (17,DATE(NOW() - INTERVAL 5 HOUR), DATE(NOW() - INTERVAL 1 DAY), NOW(), 'user3', 11,1,4,1);