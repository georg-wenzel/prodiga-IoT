...
INSERT INTO room (ID, NAME, object_created_date_time, object_created_user_username) VALUE (1, 'Test Room 1', CURRENT_TIMESTAMP, 'admin');
INSERT INTO room (ID, NAME, object_created_date_time, object_created_user_username) VALUE (2, 'Test Room 2', CURRENT_TIMESTAMP, 'admin');
INSERT INTO room (ID, NAME, object_created_date_time, object_created_user_username) VALUE (3, 'Test Room 3', CURRENT_TIMESTAMP, 'admin');
